...
import { AlertCircleIcon, GalleryVerticalEnd, MailCheck } from 'lucide-react'
        ...
        <motion.form onSubmit={handleSubmit(onSubmit)} variants={staggerItem}>
          <FieldGroup>
            ...
            <motion.div
              ...
              className='space-y-4'
            >
              <EmailInput control={control} disabled={showConfirmEmail} />
              <PasswordInput control={control} disabled={showConfirmEmail} />
        ...
        <AlertDialogContent>
          <AlertDialogHeader>
            ...
            <AlertDialogDescription>
              ...
              You can safely close this page while you check your inbox.
            </AlertDialogDescription>
          </AlertDialogHeader>
        </AlertDialogContent>
      </AlertDialog>
